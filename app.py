...
# ===== FINANCIFY LOGIN + USAGE PROTECTION =====
from protect_tool import require_tool_access, record_tool_use
FINANCIFY_TOOL_NAME = "macro-dance-floor"
require_tool_access(FINANCIFY_TOOL_NAME, "Macro Dance Floor")
# =============================================
...
if analyze:
    record_tool_use(FINANCIFY_TOOL_NAME)
card_end()
